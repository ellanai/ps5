...
alt.Chart(df_2021).mark_line(color='#8dd3c7').transform_timeunit(
    ...
    x=alt.X(
        ...
        axis=alt.Axis(
            ...
            labelAngle=-45,
            tickCount='month',
            grid=True,  # Enable grid only for specified ticks
            gridColor='lightgrey',  # Customize grid color
            gridDash=[2, 2]  # Customize grid line style  
        )
    ),
...
alt.Chart(df_2021).mark_line(color='#8dd3c7').transform_timeunit(
    ...
    x=alt.X(
        ...
        title='Month and Year (2021-2024)',
        axis=alt.Axis(
            format="%b %Y",  # Show abbreviated month and full year
            labelAngle=-45,
            tickCount='month',  # Set ticks based on months
            values=['2021-01', '2021-04', '2021-08', '2021-12', 
                    '2022-01', '2022-04', '2022-08', '2022-12',
